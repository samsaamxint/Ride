...
//                    }
                ...
                HStack {
                    Image("ride")
                        ...
                        .frame(width: 50, height: 50).padding(.leading, 20).padding(.top, 10).padding(.bottom, 10)
                    VStack(alignment: .leading) {
                        Text(context.attributes.gameName).font(.system(size: 14, weight: .bold)).foregroundColor(.white).padding(.top, 10).padding(.leading, 10)
                        Text(context.state.bottomText).font(.system(size: 12, weight: .regular)).foregroundColor(.black)
                    }
                    Spacer()
                  
                }.padding(5).background(Color.init(.black), in: Rectangle())
